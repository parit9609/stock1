...
class LinearRegressionModel(BaseMLModel):
    ...
    def __init__(self):
        super().__init__("Linear Regression", needs_scaling=True)
...
class RandomForestModel(BaseMLModel):
    ...
    def __init__(self, n_estimators: int = 100, max_depth: int = None, 
        ...
        super().__init__("Random Forest", needs_scaling=False)
    ...
    def fit(self, X: np.ndarray, y: np.ndarray) -> Dict[str, Any]:
        ...
        """
        try:
            # For tree-based models, we don't need to scale features
...
class XGBoostModel(BaseMLModel):
    ...
    def __init__(self, n_estimators: int = 100, max_depth: int = 6, 
                 ...
                 early_stopping_rounds: int = 50, eval_metric: str = 'rmse'):
        self.n_estimators = n_estimators
        self.max_depth = max_depth
        ...
        super().__init__("XGBoost", needs_scaling=False)
    ...
    def fit(self, X: np.ndarray, y: np.ndarray, X_val: np.ndarray = None, y_val: np.ndarray = None) -> Dict[str, Any]:
        """
        Fit the model to the training data with optional validation for early stopping
        
        Args:
            X (np.ndarray): Training features
            y (np.ndarray): Training targets
            X_val (np.ndarray): Validation features for early stopping
            y_val (np.ndarray): Validation targets for early stopping
        ...
        try:
            # For tree-based models, we don't need to scale features
            # XGBoost handles different scales well
...
class LightGBMModel(BaseMLModel):
    ...
    def __init__(self, n_estimators: int = 100, max_depth: int = 6, 
                 ...
                 reg_alpha: float = 0.1, reg_lambda: float = 0.1):
        self.n_estimators = n_estimators
        self.max_depth = max_depth
        self.learning_rate = learning_rate
        self.random_state = random_state
        ...
        super().__init__("LightGBM", needs_scaling=False)
    ...
    def fit(self, X: np.ndarray, y: np.ndarray, X_val: np.ndarray = None, y_val: np.ndarray = None) -> Dict[str, Any]:
        ...
        try:
            # For tree-based models, we don't need to scale features
            # LightGBM handles different scales well
